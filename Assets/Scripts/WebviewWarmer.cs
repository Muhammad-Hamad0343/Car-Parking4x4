...
public static class WebviewWarmer
{
    ...
    private static IEnumerator PreWarmRoutine()
    {
        ...
        activity.Call("runOnUiThread", new AndroidJavaRunnable(() =>
        {
            ...
            {
                Debug.LogError("Exception occurred while creating webview " + e);
        ...
        Debug.Log($"Warmed Up Success {isWebViewWarmedUp} and {isExceptionOccurred}");
        ...
        //    {
        //        isExceptionOccurred = true;
        //        Debug.LogError("Exception occurred while registering webview " + e);

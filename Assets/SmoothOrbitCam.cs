...
public class SmoothOrbitCam : MonoBehaviour
{
    ...
    [Space(20)]
    [Header("RestrictedArea")]
    public Rect restrictedArea = new Rect(100, 100, 200, 300);
    ...
    void LateUpdate()
    {
        ...
        //if(MM_Manager._instance.Garage.activeInHierarchy && !MM_Manager._instance.InApp.activeInHierarchy && !StoreHandlerV3._instance.lessCashinDollarsPanel.activeInHierarchy)
        {
            ...
            if (target)
            {
                ...
                if (useTouch)
                {
                    ...
                    if (Input.touchCount == 1)
                    {
                        ...
                        if (isLandscape)
                        {
                            if (touchPos.y < 150)//screenHeight / 2)//(touchPos.x < screenWidth / 2) || 
                            {
                                //Block area
                            }
                            else
